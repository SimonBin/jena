...
/**
 * Class used to map a given scoped OpService to a normed form.
 * A normed query with a non-empty set of variables always has variables at scope level 0.
 * I.e. norming a query
 *
 *
 *  such as the mentioned variables
...
public class OpServiceInfo {
    ...
    // protected Map<Var, Var> visibleSubOpVarsScopedToPlain;
     // protected Set<Var> visibleSubOpVarsScoped;

    // protected Set<Var> mentionedSubOpVarsPlainToScoped;
    // protected Map<Var, Var> mentionedSubOpVarsScopedToPlain;
    // protected Set<Var>      mentionedSubOpVarsPlain;
    ...
    public OpServiceInfo(OpService opService) {
        ...
        mentionedSubOpVarsScopedToNormed = VarUtils.normalizeVarScopes(mentionedSubOpVars);
        ...
        this.visibleSubOpVarsScopedToNorm = VarUtils.normalizeVarScopesGlobal(visibleSubOpVars);

        this.normQuery = OpAsQuery.asQuery(normedQueryOp);

        VarExprList vel = normQuery.getProject();
