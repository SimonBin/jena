...
public class IteratorUtils {
     ...
     *
     * @param isLeftJoin If true then every item in lhs will lead to a result.
     *                   Otherwise, result items with an empty iterator for rhs will be omitted.
     */
    public static <K, X, Y> AbstractIterator<Cell<K, X, Iterator<Y>>> partialLeftMergeJoin(
        ...
        return new AbstractIterator<Cell<K, X, Iterator<Y>>>() {
            @Override
                    ...
                    if (lhsKvIt.hasNext()) {
                        ...
                        if (rhsKvIt.hasNext()) {
                            ...
                            if (Objects.equals(lhsK, rhsK)) {
                                rhsSubIt = new AbstractIterator<Y>() {
                                    @Override
