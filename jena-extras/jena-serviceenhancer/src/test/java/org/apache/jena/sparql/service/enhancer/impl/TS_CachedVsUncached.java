...
public class TS_CachedVsUncached {
    ...
    public TS_CachedVsUncached(String name, String queryStrA, String queryStrB, Model model, Consumer<Context> cxtMutator) {
        super();
        this.name = name;
    ...
    @Test
    public void test() {
        Log.debug(TS_CachedVsUncached.class, "Query A: " + queryStrA);
        Log.debug(TS_CachedVsUncached.class, "Query B: " + queryStrB);
...

    {
        ...
        Model model = TS_ResultSetLimits.createModel(resourceCount);
        ...
        for (int i = 0; i < 1000; ++i) {
            ...
            Log.debug(TS_CachedVsUncached.class, info);
            ...
            Consumer<Context> cxtMutator = cxt-> {
                InitServiceEnhancer.wrapOptimizer(cxt);
