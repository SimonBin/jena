...
import org.apache.jena.dboe.storage.advanced.tuple.SubIndexNodeFactory;
...
//    default Stream<Tuple<ComponentType>> streamEntriesMultiMap(J parentKey, Map<V, C>) {
//        // let the parent pass all its pair to this method so we can do a nested lookup
//    	getParent().getParent().streamEntries()
//    }
