    ...
    public QueryIterator createExecution(OpService opService, QueryIterator input, ExecutionContext execCxt,
        ...
        outer: for (; i < n; ++i) {
            ...
            case ServiceOpts.SO_BULK: // Enables bulk requests
                ...
                int maxBulkSize = cxt.get(InitServiceEnhancer.serviceBulkMaxBindingCount, ChainingServiceExecutorBulkCache.MAX_BULK_SIZE);
                bulkSize = cxt.get(InitServiceEnhancer.serviceBulkBindingCount, ChainingServiceExecutorBulkCache.DEFAULT_BULK_SIZE);
                try {
